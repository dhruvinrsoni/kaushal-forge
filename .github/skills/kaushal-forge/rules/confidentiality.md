...
7. **Add the person's internal codenames / client names / manager & peer names to `config.verify.forbidden_terms`** so `verify.py` will hard-fail if any leak into outputs.
