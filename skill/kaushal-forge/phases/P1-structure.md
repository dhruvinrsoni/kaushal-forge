...
4. **Collect (for the operator) any internal codenames / client names / manager & peer names you stripped** — list them at the end of your message so they can be added to `config.verify.forbidden_terms`.
